...
const About = () => {
  ...
  return (
    <AboutGridContainer>
      <AboutStatementContainer>{about}</AboutStatementContainer>
      <AboutImageContainer>
        <NoelleImage src={noelle} alt="Noelle Image" />
      </AboutImageContainer>
      <AboutInfoContainer>
        <AboutBioContainer>{bio}</AboutBioContainer>
        <AboutContAndInfoContainer>
          <VIEWCV onClick={openS3Pdf}>
            <UnderlinedText>VIEW CV</UnderlinedText>
          </VIEWCV>
          <ContactInfo>
            INSTAGRAM:{" "}
            <UnderlinedLink href="https://www.instagram.com/noelle.tart">
              @noelletart
            </UnderlinedLink>
          </ContactInfo>
          <ContactInfo>
            EMAIL:{" "}
            <UnderlinedLink href="mailto:noelletart@gmail.com">
              noelletart@gmail.com
            </UnderlinedLink>
          </ContactInfo>
        </AboutContAndInfoContainer>
      </AboutInfoContainer>
